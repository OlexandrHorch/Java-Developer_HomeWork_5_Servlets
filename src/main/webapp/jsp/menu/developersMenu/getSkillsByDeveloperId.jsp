...
<html>
    ...
    <body>
        ...
        <h1>Виберіть розробника для отримання інформації про вміння</h1>
            <form action="/menu/developersMenu/getSkillsByDeveloperIdAnswer" method="GET">
                <p>
                ...
                <p>
                    <button style="width:170px;height:30px" type="submit">Показати вміння</button>
                </p>
            </form>
    </body>
</html>